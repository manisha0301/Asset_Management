      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-full overflow-y-auto">
        ...
        <div className="p-6">
          <div className="space-y-0">
            ...
            {/* Supplier */}
            <div className="flex">
              <div className="w-1/3 p-3 font-medium text-gray-700">Supplier</div>
              <div className="w-2/3 p-3 text-gray-600">{asset.supplier || "N/A"}</div>
            </div>
            ...
            {/* Sub Department */}
            <div className="flex">
              <div className="w-1/3 p-3 font-medium text-gray-700">Sub Department</div>
              <div className="w-2/3 p-3 text-gray-600">{asset.subDepartment || "N/A"}</div>
            </div>
