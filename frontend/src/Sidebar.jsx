...
export default function Sidebar({ sidebarVisible, currentPage, setCurrentPage }) {
  ...
  return (
    <div className={`${sidebarVisible ? 'w-64 ' : 'w-0'} bg-slate-800 text-white transition-all duration-300 ease-in-out overflow-y-auto`}>
      {/* Logo */}
      <div className="p-4 border-b border-slate-700">
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <div className="text-xs text-gray-300">Kristellar Aerospace Strategic Management Assets</div>
          </div>
        </div>
      </div>
          ...
          <li>
            <div className="px-4 py-3">
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 transform transition-transform ${requestModuleOpen ? 'rotate-180' : ''}`} />
              </div>
              {requestModuleOpen && (
                <div className="mt-2 ml-8 space-y-1">
                  <a href="#" className="block px-4 py-2 text-gray-400 hover:text-white hover:bg-slate-700 rounded">
          ...
          <li>
            <div className="px-4 py-3">
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 transform transition-transform ${reportOpen ? 'rotate-180' : ''}`} />
              </div>
              {reportOpen && (
                <div className="mt-2 ml-8 space-y-1">
                  <a href="#" className="block px-4 py-2 text-gray-400 hover:text-white hover:bg-slate-700 rounded">
